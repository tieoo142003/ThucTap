	...
	<div id="page">
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="index.jsp">Trang Chủ</a></span> / <span>Nam</span></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="breadcrumbs-two">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="breadcrumbs-img" style="background-image: url(/images/sandalBanner.jpeg);">
							<h2  style="color:aliceblue">Nam</h2>
						</div>
								...
								<div class="col-lg-4 mb-4 text-center">
									<div class="product-entry border">
										<a href="/sandal/detail/${p.id}" class="prod-img">
											...
											<div class="card-img-overlay d-flex justify-content-around align-items-center" id="cart-overplay">
